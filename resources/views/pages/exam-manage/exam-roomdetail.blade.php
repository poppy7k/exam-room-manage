...
<form id="addSeatForm" method="POST" action="" class="pt-4" enctype="multipart/form-data" onsubmit="saveSeats()">
    @csrf
    @method('PUT')
    <x-buttons.primary type="submit" class="py-2 w-full hover:scale-105 justify-center"> บันทึกที่นั่ง </x-buttons.primary>
</form>
