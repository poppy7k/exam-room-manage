        ...
        <div class="flex gap-1">
            <div x-data="{ showFilterBuilding: false }" class="z-40"> 
                <x-buttons.icon-primary @click="showFilterBuilding = !showFilterBuilding" id="filter-building" onclick="event.stopPropagation();" class="px-[5px] pt-1.5 pb-1 z-40">
                    ...
                    <x-tooltip title="ฟิลเตอร์อาคารสอบ" class="group-hover:-translate-x-11 translate-y-0.5"></x-tooltip>
                </x-buttons.icon-primary>
                @include('components.dropdowns.building-list.filter')
            </div>
            <x-buttons.icon-primary type="submit" onclick="window.location.href = '{{ route('exam-create') }}'" class="px-[5px] py-1 z-40">
                ...
                <x-tooltip title="สร้างการสอบ" class="group-hover:-translate-x-8 translate-y-1"></x-tooltip>
            </x-buttons.icon-primary>
