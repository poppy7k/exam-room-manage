            ...
            <div class="flex justify-between items-center">
                ...
                <div class="flex gap-4">
                    ...
                    <div x-data="{ showFilterRoom: false }" class="z-40"> 
                        <x-buttons.icon-primary @click="showFilterRoom = !showFilterRoom" id="filter-room" onclick="event.stopPropagation();" class="px-[5px] pt-1.5 pb-1 z-40 from-white to-white">
                    ...
                    <x-buttons.icon-primary type="button" onclick="window.location.href = '{{ route('pages.room-create', ['buildingId' => $building->id]) }}'" class="px-[5px] py-1 z-40 from-white to-white">
