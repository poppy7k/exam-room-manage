...
<div class="bg-white shadow-lg px-16 py-10 my-3 border-1 rounded-lg divide-y-2">
    ...
    <form method="POST" class="pt-4" action="{{ route('buildings.store') }}" enctype="multipart/form-data" onsubmit="return validateForm()">
        ...
        <div class="mb-4">
            ...
            <input type="text" id="building_th" placeholder="กรอกชื่ออาคาร (ภาษาไทย)" required class="w-full my-2 px-3 py-2 rounded ring-1 shadow-sm ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-green-600 transition-all duration-300 outline-none">
        ...
        <div class="mb-4">
            ...
            <input type="text" id="building_en" placeholder="กรอกชื่ออาคาร (English)" required class="w-full my-2 px-3 py-2 rounded ring-1 shadow-sm ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-green-600 transition-all duration-300 outline-none">
