...
<div class="room-item relative flex bg-white flex-col bg-clip-border rounded-lg w-[260px] shadow-md mt-6 transition-all duration-500 hover:scale-105 hover:shadow-lg" data-room-id="{{ $room_id }}">
    ...
    @endif
    <div class="hidden select-room-button room-checked absolute flex flex-col gap-2 justify-center items-center inset-0 z-20 bg-green-300/90 rounded-lg cursor-pointer transition-all duration-100 group hover:bg-red-300/90">
