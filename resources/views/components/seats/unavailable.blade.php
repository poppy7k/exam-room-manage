<div class="seat">
    <button
        class="group relative w-max rounded-lg mb-1 flex flex-col items-center justify-center text-sm transition-all duration-500 hover:fill-gray-700 hover:text-gray-700 hover:font-semibold hover:scale-110 fill-gray-600 opacity-50 text-gray-600 hover:opacity-100">
        <p>{{ $slot }}</p>
        ...
        <p class="absolute text-xs translate-y-3 text-white bg-red-500 rounded p-1 whitespace-nowrap">ไม่พร้อม</p>
    </button>
</div>
