    ...
    <a href="{{ $href }}">
        ...
        <div class="p-4 text-surface text-black">
            ...
            <div class="flex justify-between pt-1">
                <x-buttons.primary type="button" onclick="">
                    เลือก
                </x-buttons.primary>
                <x-buttons.icon-info type="button" onclick="openModal({ id: {{ $building_id }}, building_th: '{{ $building_th }}', building_en: '{{ $building_en }}' })" class="px-1 py-1">
                ...
                <x-buttons.icon-danger type="button" onclick="deleteBuilding('{{ $building_id }}')" class="px-1 py-1">
