    ...
    <a href="{{ route('pages.room-list', ['buildingId' => $building_id]) }}" class="absolute inset-0 z-0"></a>
        ...
        <div class="p-4 text-surface text-black">
            ...
            <div class="flex justify-between py-1">
                ...
                <x-buttons.icon-danger type="button" onclick="event.stopPropagation(); deleteBuilding('{{ $building_id }}', '{{ $building_th }}')" class="px-1 py-1 z-10">
...
<script>
    function deleteBuilding(buildingId, buildingName) {
        showConfirmationModal(
            'danger', 
            'ยืนยันการลบอาคารสอบ', 
            `คุณต้องการลบ ${buildingName} ใช่ไหม`,
            () => {
    ...
    function copyToClipboard(text) {
        ...
        showNotification('success', '' , 'คัดลอกแผนที่อาคารสอบเสร็จสิ้น')
    }
</script>