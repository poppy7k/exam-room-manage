    ...
    <a href="{{ route('pages.room-list', ['buildingId' => $building_id]) }}" class="absolute inset-0 z-0"></a>
        ...
        <div class="p-4 text-surface text-black">
            ...
            <div class="flex justify-between py-1">
                ...
                <x-buttons.icon-info type="button" onclick="event.stopPropagation(); openModal({ id: {{ $building_id }}, building_th: '{{ $building_th }}', building_en: '{{ $building_en }}' })" class="px-1 py-1 z-10">
