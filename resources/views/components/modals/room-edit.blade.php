<div id="editRoomModal" class="fixed z-30 inset-0 hidden">
                ...
                <div class="bg-white px-4 pb-4 sm:p-6 sm:pb-4">
                    <div class="sm:flex sm:items-start">
                        <div class="mt-3 pt-3 text-center sm:mt-0 sm:ml-4 sm:text-left divide-y-2 w-full mr-4">
                            <h3 class="text-2xl leading-6 font-medium text-gray-900" id="modal-title">Edit Room Information</h3>
                            <div class="mt-4">
                                <div class="mb-4 mt-4">
                                    <label for="floor_edit" class="block text-gray-700 font-semibold">Floor:</label>
                                    <input type="text" name="floor_edit" id="floor_edit" class="w-full px-3 py-2 border border-gray-300 rounded-md">
                                </div>
                                <div class="mb-4">
                                    <label for="room_edit" class="block text-gray-700 font-semibold">Room:</label>
                                    <input type="text" name="room_edit" id="room_edit" class="w-full px-3 py-2 border border-gray-300 rounded-md">
                                </div>
                            </div>
                        </div>
                    </div>
