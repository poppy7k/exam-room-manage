        ...
        <div
                ...
                <div class="sm:flex sm:items-start">
                    <div class="mt-3 pt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full mr-4">
                        <div>
                            ...
                            <div class="mb-4 mt-4">
                                <input type="text" id="search-staff-input"
                                    class="w-full px-5 py-2 rounded-full ring-1 shadow-sm ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-green-600 transition-all duration-300 outline-none"
            ...
            <div class="bg-gray-200 px-4 pb-4 sm:px-6 sm:flex sm:flex-row-reverse">
                <div class="flex pt-4 pr-4 gap-4">
                    <x-buttons.secondary id="close-modal-btn" type="button"
