                    ...
                    <div class="sm:flex sm:items-start">
                        <div class="mt-3 pt-3 text-center sm:mt-0 sm:ml-4 sm:text-left divide-y-2 w-full mr-4">
                            <h3 class="text-2xl leading-6 font-medium text-gray-900" id="modal-title">
                                แก้ไขข้อมูลอาคารสอบ</h3>
                            <div class="mt-4">
                                <div class="mb-4 mt-4">
                                    <label for="building_th_edit" class="block text-gray-700 font-semibold">ชื่ออาคารสอบ
                                        (ภาษาไทย)</label>
                                    <input type="text" name="building_th_edit" id="building_th_edit"
                                    ...
                                    <span id="building_th_edit_error" class="error-message"
                                        style="color: red; display: none;">*
                                        กรุณากรอกชื่ออาคารด้วยภาษาไทยหรือตัวเลขเท่านั้น!</span>
                                </div>
                                <div class="mb-4">
                                    <label for="building_en_edit" class="block text-gray-700 font-semibold">ชื่ออาคารสอบ
                                        (English)</label>
                                    <input type="text" name="building_en_edit" id="building_en_edit"
                                        class="w-full my-2 px-3 py-2 rounded ring-1 shadow-sm ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-green-600 transition-all duration-300 outline-none">
                                    <span id="building_en_edit_error" class="error-message"
                                        style="color: red; display: none;">*
                                        กรุณากรอกชื่ออาคารด้วยภาษาอังกฤษหรือตัวเลขเท่านั้น!</span>
                                </div>
                                <div class="mb-4">
                                    <label for="building_map_url_edit"
                                        class="block font-semibold">ลิ้งค์แผนที่ของอาคารสอบ</label>
                                    <input type="text" id="building_map_url_edit" name="building_map_url_edit"
                                        placeholder="กรอกลิ้งค์แผนที่ของอาคารสอบ"
                                        class="w-full my-2 px-3 py-2 rounded ring-1 shadow-sm ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-green-600 transition-all duration-300 outline-none">
                                </div>
                                <div class="mb-4">
                                    <label for="building_image_edit"
                                        class="block text-gray-700 font-semibold">รูปภาพของอาคารสอบ</label>
                                    <input type="file" name="building_image_edit" id="building_image_edit"
