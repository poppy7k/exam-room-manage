<div class="seat">
    <button class="w-max rounded-lg mb-3 flex flex-col items-center justify-center text-sm transition-all duration-500 hover:fill-green-700 hover:text-green-700 hover:font-semibold hover:scale-110">
        <p>{{ $slot }}</p>
