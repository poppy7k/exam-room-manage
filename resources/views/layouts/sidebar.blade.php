    ...
    <aside class="bg-gradient-to-br from-gray-800 to-gray-900 z-50 h-screen w-72 transition-transform duration-300 hidden lg:block col-start-1 col-span-1">
        ...
        <div class="px-6 py-6">
            <ul class="mb-4 flex flex-col gap-6">
                <li class="sidebar-menu-list transition-all duration-500">
                    <a aria-current="page" class="active" href="{{ route('building-list') }}">
                        <x-buttons.primary type="button" class="sidebar-menu-button w-full py-3 px-12 rounded-lg pl-10 justify-start h-12" onclick="">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" class="sidebar-menu-icon w-5 h-5 text-inherit transition-all duration-500 ease-in-out">
                                <path d="M11.47 3.84a.75.75 0 011.06 0l8.69 8.69a.75.75 0 101.06-1.06l-8.689-8.69a2.25 2.25 0 00-3.182 0l-8.69 8.69a.75.75 0 001.061 1.06l8.69-8.69z"></path>
                                <path d="M12 5.432l8.159 8.159c.03.03.06.058.091.086v6.198c0 1.035-.84 1.875-1.875 1.875H15a.75.75 0 01-.75-.75v-4.5a.75.75 0 00-.75-.75h-3a.75.75 0 00-.75.75V21a.75.75 0 01-.75.75H5.625a1.875 1.875 0 01-1.875-1.875v-6.198a2.29 2.29 0 00.091-.086L12 5.43z"></path>
                            </svg>
                            <p class="sidebar-menu-label">หน้าหลัก</p>
                        </x-buttons.primary>
                    </a>
                </li>
                <li class="sidebar-menu-list transition-all duration-500">
                    <a aria-current="page" class="active" href="{{ route('building-list') }}">
                        <x-buttons.secondary type="button" class="sidebar-menu-button w-full py-3 px-12 rounded-lg pl-10 justify-start h-12" onclick="">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" class="sidebar-menu-icon w-5 h-5 text-inherit transition-all duration-500 ease-in-out">
                                <path d="M11.47 3.84a.75.75 0 011.06 0l8.69 8.69a.75.75 0 101.06-1.06l-8.689-8.69a2.25 2.25 0 00-3.182 0l-8.69 8.69a.75.75 0 001.061 1.06l8.69-8.69z"></path>
                                <path d="M12 5.432l8.159 8.159c.03.03.06.058.091.086v6.198c0 1.035-.84 1.875-1.875 1.875H15a.75.75 0 01-.75-.75v-4.5a.75.75 0 00-.75-.75h-3a.75.75 0 00-.75.75V21a.75.75 0 01-.75.75H5.625a1.875 1.875 0 01-1.875-1.875v-6.198a2.29 2.29 0 00.091-.086L12 5.43z"></path>
                            </svg>
                            <p class="sidebar-menu-label">จัดการห้องสอบ</p>
                        </x-buttons.secondary>
                    </a>
                </li>
                <li class="sidebar-menu-list transition-all duration-500">
                    <a aria-current="page" class="active" href="{{ route('building-list') }}">
                        <x-buttons.secondary type="button" class="sidebar-menu-button w-full py-3 px-12 rounded-lg pl-10 justify-start h-12" onclick="">
                            ...
                            <p class="sidebar-menu-label">จัดการการสอบ</p>
                        </x-buttons.secondary>
                    </a>
                </li>
            </ul>
    ...
    function openSidebar() {
      ...
      //for collapse button
        document.querySelectorAll(".sidebar-menu-list").forEach(element => {
            element.classList.toggle("transหlate-x-8");
        });
